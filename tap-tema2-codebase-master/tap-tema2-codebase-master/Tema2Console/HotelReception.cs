...
namespace Tema2Console
{
    public class HotelReception
    {
        ...
        private readonly OrderSerializer _orderSerializer;
        private readonly IOrderProcessor _orderProcessor;
        public HotelReception(FileHandler fileHandler, OrderSerializer orderSerializer, IOrderProcessor orderProcessor)
        {
        ...
        //
        public decimal FinalPrice { get; /*modificare*/private set; }
